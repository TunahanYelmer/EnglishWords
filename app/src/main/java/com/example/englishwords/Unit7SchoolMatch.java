...
public class Unit7SchoolMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("School", Unit7SchoolMatch.this);
    ...
    private void loadImageIntoView(ImageView imageView, String imageFileName) {
        FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("School", imageFileName);
