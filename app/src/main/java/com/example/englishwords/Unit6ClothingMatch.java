...
public class Unit6ClothingMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Clothing", Unit6ClothingMatch.this);
    ...
    private void loadImageIntoView(ImageView imageView, String imageFileName) {
        FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Clothing", imageFileName);
