...
public class Unit4FoodMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Food", Unit4FoodMatch.this);
    ...
    private void loadImageIntoView(ImageView imageView, String imageFileName) {
        FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Food", imageFileName);
