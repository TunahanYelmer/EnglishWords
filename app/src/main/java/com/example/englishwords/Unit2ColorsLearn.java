...
public class Unit2ColorsLearn extends AppCompatActivity {
    ...
    private void displayNextQuestion() {
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Colors", Unit2ColorsLearn.this);
        fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
            ...
            if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                ...
                FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Colors",vocabulary.getImageFileName(word));
