...
public class Unit4FoodTest extends AppCompatActivity {
    ...
    private void setOptions() {
        ...
        new Handler().postDelayed(() -> {
            FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Food", Unit4FoodTest.this);
            fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
                ...
                if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                    ...
                    FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Food", vocabulary.getImageFileName(correctWord));
