...
public class Unit3AnimalsTest extends AppCompatActivity {
    ...
    private void setOptions() {
        ...
        new Handler().postDelayed(() -> {
            FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Animals", Unit3AnimalsTest.this);
            fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
                ...
                if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                    ...
                    FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Animals", vocabulary.getImageFileName(correctWord));
