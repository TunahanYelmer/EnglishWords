...
public class Unit5FruitsMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Fruits", Unit5FruitsMatch.this);
    ...
    private void loadImageIntoView(ImageView imageView, String imageFileName) {
        FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Fruits", imageFileName);
