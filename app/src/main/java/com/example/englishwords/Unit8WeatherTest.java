...
public class Unit8WeatherTest extends AppCompatActivity {
    ...
    private void setOptions() {
        ...
        new Handler().postDelayed(() -> {
            FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Weather", Unit8WeatherTest.this);
            fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
                ...
                if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                    ...
                    FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Weather", vocabulary.getImageFileName(correctWord));
