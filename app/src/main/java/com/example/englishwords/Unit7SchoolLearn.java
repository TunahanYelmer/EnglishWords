...
public class Unit7SchoolLearn extends AppCompatActivity {
    ...
    private void displayNextQuestion() {
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("School", Unit7SchoolLearn.this);
        fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
            ...
            if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                ...
                FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("School",vocabulary.getImageFileName(word));
