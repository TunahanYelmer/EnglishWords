...
public class Unit6ClothingTest extends AppCompatActivity {
    ...
    private void setOptions() {
        ...
        new Handler().postDelayed(() -> {
            FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Clothing", Unit6ClothingTest.this);
            fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
                ...
                if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                    ...
                    FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Clothing", vocabulary.getImageFileName(correctWord));
