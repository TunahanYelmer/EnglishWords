...
public class Unit2ColorsMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Colors", Unit2ColorsMatch.this);
    ...
    private void loadImageIntoView(ImageView imageView, String imageFileName) {
        FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Colors", imageFileName);
