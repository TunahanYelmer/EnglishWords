...
public class Unit4FoodLearn extends AppCompatActivity {
    ...
    private void displayNextQuestion() {
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Food", Unit4FoodLearn.this);
        fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
            ...
            if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                ...
                FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Food",vocabulary.getImageFileName(word));
