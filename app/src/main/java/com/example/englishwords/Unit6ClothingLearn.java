...
public class Unit6ClothingLearn extends AppCompatActivity {
    ...
    private void displayNextQuestion() {
        FireStoreDatabase fireStoreDatabase = new FireStoreDatabase("Clothing", Unit6ClothingLearn.this);
        fireStoreDatabase.getVocabulary().thenAccept(vocabulary -> {
            ...
            if (vocabulary != null && !vocabulary.getWords().isEmpty()) {
                ...
                FirebaseStorageHelper firebaseStorageHelper = new FirebaseStorageHelper("Clothing",vocabulary.getImageFileName(word));
